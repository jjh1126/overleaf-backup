...
Several directions remain for future work. First, because \(\ecf{}\) characterizes the residual substrate state independently of the specific greedy embedding procedure used in this paper, it may also be incorporated into learning-based VNE frameworks. In such settings, the connectivity-aware fragmentation information provided by \(\ecf{}\) could be used to enrich the information available to a learned embedding policy, for example through state representation or reward design.
