...
\begin{itemize}
    ...
    \item 정상상태 평가를 위해 평균 VNR 수명의 10배에 해당하는 초기 시간을 제외하였다.
...
\begin{itemize}
    ...
    $\Delta=100$, $K=10$ and $\tau=3$ for computational tractability.
...
\end{figure}
% Acceptance ratio
%  	VNE-ECF-LB	VNE-ECF	VNE-RFD-B	VNE-RFD-D	D-ViNE	R-ViNE
