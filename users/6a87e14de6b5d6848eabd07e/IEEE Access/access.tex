...
embedding. Since evaluating link external connectivity requires summing over
the endpoint neighborhoods and every substrate node has degree at most
$|N^S|-1$, one objective evaluation requires
$T_J=O(|N^V|+|L^V||N^S|+|N^S||L^S|)$. Substituting $T_J$ into the per-path
cost, the overall worst-case complexity of VNE-ECF-LB is
$
    O\Big(
    |N^S||N^V|
    +
