...
algorithm for loopless $K$-shortest paths~\cite{yen1971finding}, whose
complexity is $O\big(K|N^S|(|L^S|+|N^S|\log_2|N^S|)\big)$. Therefore,
excluding objective evaluation, node-candidate search and path generation
require
$O\big(|N^S||N^V|+
K|N^S|^2|L^V|(|L^S|+|N^S|\log_2|N^S|)\big)$ time.
...
overall worst-case complexity of VNE-ECF-LB is
$
    O\Big(
    |N^S||N^V|
    +
