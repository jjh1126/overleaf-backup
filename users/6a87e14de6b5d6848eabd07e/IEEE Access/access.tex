...
For accepted VNRs, let $\mathcal{R}_{\mathrm{acc}}(T)$ denote the set
of VNRs accepted during $[0,T]$. The long-term average revenue rate is
defined as
\begin{equation}
\mathrm{AR}
=
...
\mathrm{AC}
=
\frac{1}{|\mathcal{R}_{\mathrm{acc}}|}
\sum_{r\in\mathcal{R}_{\mathrm{acc}}}\mathrm{Cost}(r).
