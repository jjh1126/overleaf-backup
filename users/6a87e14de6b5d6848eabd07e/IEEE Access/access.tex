...
Another direction is to investigate the integration of the proposed fragmentation metric into learning-based VNE frameworks. Because \ecf{} characterizes the residual substrate state independently of the particular greedy embedding procedure used in this work, its connectivity-aware fragmentation information may also be useful to learned embedding policies, for example as part of the state representation or reward design.
