...
fragmentation metric that drives node selection, in the path search ($K$ candidate minimum-hop paths vs. a
single one), in the root placement rule, and in the presence of backtracking, which
